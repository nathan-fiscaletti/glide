...
public class PongEngine extends Engine {
    ...
    public void onEngineStart() {
        Scene<PongEngine> mainScreen = new Scene<PongEngine>("Pong", this) {
                ...
                this.setController(new EntityController<PongEngine>(this) {
                    {
                        ...
                        instructions = new Text<PongEngine>(
                        ...
                        this.getParentEngine().addGlobalDrawable(logo);
                        this.getParentEngine().addGlobalDrawable(instructions);
                        this.getParentEngine().addGlobalDrawable(score);
            ...
            {
                if (! ball.isStarted()) {
                    logo.setShouldRenderWhenGlobal(true);
                    instructions.setShouldRenderWhenGlobal(true);
                    ...
                    logo.setShouldRenderWhenGlobal(false);
                    instructions.setShouldRenderWhenGlobal(false);
                    worthText.setShouldRenderWhenGlobal(true);
                }
                
                score.setText(paddle1.score + " - " + paddle2.score);
