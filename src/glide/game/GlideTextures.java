...
import two.d.engine.graphics.ImageFunctions;
import two.d.engine.graphics.SpriteSheet;
import two.d.engine.graphics.Textures;

public class GlideTextures extends Textures {
	...
	public BufferedImage player,enemy,enemy2,enemy3,bullet,enemybullet,enemybulletleft,enemybulletright,healthbar1,healthbar2,healthbar3,
	 healthbar4,healthbar5,healthbar6,healthbar7,healthbar8,powerbar1,powerbar2,powerbar3,powerbar4,powerbar5,healthpack,beam, diamond, diamond2, diamond3,player2,playerhurt,
	...
	public GlideTextures() throws IOException
	{
		super(new SpriteSheet(BufferedImageLoader.load("/images/sprite_sheet.png"), 32, 32));
	}
